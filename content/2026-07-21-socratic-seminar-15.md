+++
title = "Seminari Socràtic #15"
template = "post.html"
draft = false
+++

### Agenda
19:00h Presentacions\
19:15h Seminari Socràtic on es revisaran múltiples temes relacionats amb Bitcoin\
21:00h Tancament

### Ubicació
C/ Sant Domenec 13, Sant Cugat del Valles [Google Maps]

### Anuncis
Estem molt contents de poder presentar el nostre quinzè [Seminari Socràtic](/about)!\
Agraiments a [B4OS](https://www.libreriadesatoshi.com/b4os) i [Bitronics](https://bitronics.store/) per ajudar amb algunes despeses del projecte.

Agrair en aquesta edició a [Rewind Bitcoin](https://rewindbitcoin.com/) per finançar l'espai i el sopar.
...
[Google Maps]: https://maps.app.goo.gl/T1xPHeq1XVQvCt6FA
